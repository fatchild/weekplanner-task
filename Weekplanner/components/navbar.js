  ...
  <nav class="navbar">
    <div class="container-fluid" id="app-nav">
      ...
      <div class="d-flex flex-direction-row align-items-center text-light">
        <p class="p-3 text-center m-auto mt-1 fw-light" id="nav-username">Ed’s Training Planner</p>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-double-down transition-short scale-up-lg-hover nudge-down" viewBox="0 0 16 16">
