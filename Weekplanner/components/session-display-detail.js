export const displaySessionDetail = (sessions, day, index) => { 
    ...
    if (sessions.data && day && index) {
        ...
        sessionInfo += `
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    <div class="d-flex flex-column text-white session-details-module bg-green-faded rounded-sm py-3 h-100">
                        <h2 class="text-center">Intensity</h2>
                        <span class="m-auto pt-2 px-2"><progress id="intensity" value="${sessionData["target_intensity"]*10}" max="100" class="w-5-em"></progress></span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex flex-column text-white session-details-module bg-green-faded rounded-sm py-3 h-100">
    ...
    <div class="p-3 overflow-auto rounded transition border-neo-brut text-white bg-cyan mb-4">
        <h1>${sessionInfo}</h1>
    </div>
    `
}